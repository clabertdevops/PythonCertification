...
list_of_persons = [('bob', 35, 'mgr'), ('lisa', 45, 'dev'), ('mel', 55, 'coach')]

list_of_age = [age for (name, age, job) in list_of_persons]

print(type(list_of_age), list_of_age)

list_of_job = list(map((lambda row: row[2]), list_of_persons))
print(type(list_of_job), list_of_job)